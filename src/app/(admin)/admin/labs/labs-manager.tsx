...
function LabFormDialog({
  ...
  const form = useForm<z.input<typeof labSchema>, unknown, z.output<typeof labSchema>>({
...
function ExerciseFormDialog({
  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
  const form = useForm<z.input<typeof exerciseSchema>, unknown, z.output<typeof exerciseSchema>>({
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" min={1} max={12} {...field} value={field.value as string | number} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
...
function ProgramFormDialog({
  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
  const form = useForm<z.input<typeof programSchema>, unknown, z.output<typeof programSchema>>({
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" min={1} max={8} {...field} value={field.value as string | number} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
